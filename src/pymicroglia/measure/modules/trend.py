...
Ported from Motion's ``analysis/modules/trend.py`` on 2026-09-21 (stage 04 of the Motion port); the arithmetic is unchanged.
"""
...
METHOD_VERSION = "2026-09-21-trend-v1"
