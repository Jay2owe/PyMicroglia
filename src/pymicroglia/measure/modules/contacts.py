...
Ported from Motion's ``analysis/modules/contacts.py`` on 2026-09-21 (stage 04 of the Motion port); the arithmetic is unchanged.
"""
...
from pymicroglia.measure.fields import longest_run as _longest_run
...
METHOD_VERSION = "2026-09-21-contacts-v1"
