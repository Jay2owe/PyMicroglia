...
Ported from Motion's ``analysis/modules/sequence_distance.py`` on 2026-09-21 (stage 04 of the Motion port); the arithmetic is unchanged.
"""
...
METHOD_VERSION = "2026-09-21-sequence_distance-v1"
