...
Ported from Motion's ``analysis/modules/object_geometry.py`` on 2026-09-21 (stage 04 of the Motion port); the arithmetic is unchanged.
"""
...
from pymicroglia.measure.fields import ground_within, longest_run
from pymicroglia.measure.context import MeasurementContext, ObjectStack
...
METHOD_VERSION = "2026-09-21-object_geometry-v1"
