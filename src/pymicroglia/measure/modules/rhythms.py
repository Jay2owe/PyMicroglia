...
Ported from Motion's ``analysis/modules/rhythms.py`` on 2026-09-21 (stage 04 of the Motion port); the arithmetic is unchanged.
"""
...
from pymicroglia.measure.defaults import MICROGLIA_METRICS
...
METHOD_VERSION = "2026-09-21-rhythms-v1"

DEFAULTS = {
    "metrics": list(MICROGLIA_METRICS),
