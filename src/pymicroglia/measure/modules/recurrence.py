...
Ported from Motion's ``analysis/modules/recurrence.py`` on 2026-09-21 (stage 04 of the Motion port); the arithmetic is unchanged.
"""
...
from pymicroglia.measure.defaults import MICROGLIA_STATE_METRICS
...
METHOD_VERSION = "2026-09-21-recurrence-v1"
...
DEFAULTS = {
    **workbench.DETREND_DEFAULTS,
    ...
    "metrics": list(MICROGLIA_STATE_METRICS),
