...
Ported from Motion's ``analysis/modules/neighbours.py`` on 2026-09-21 (stage 04 of the Motion port); the arithmetic is unchanged.
"""
...
from pymicroglia.measure.fields import ground_within
...
METHOD_VERSION = "2026-09-21-neighbours-v1"
