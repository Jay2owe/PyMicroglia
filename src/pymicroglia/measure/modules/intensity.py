...
Ported from Motion's ``analysis/modules/intensity.py`` on 2026-09-21 (stage 04 of the Motion port); the arithmetic is unchanged.
"""
...
METHOD_VERSION = "2026-09-21-intensity-v1"
