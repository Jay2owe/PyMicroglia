...
Ported from Motion's ``analysis/modules/channels.py`` on 2026-09-21 (stage 04 of the Motion port); the arithmetic is unchanged.
"""
...
from pymicroglia.measure.context import ChannelStack, MeasurementContext
...
METHOD_VERSION = "2026-09-21-channels-v1"
