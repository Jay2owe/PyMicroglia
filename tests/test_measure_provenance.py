...
Ported from Motion's ``analysis/test_provenance_module.py`` on 2026-09-21 (stage 04 of the Motion port).
"""
from __future__ import annotations

import numpy as np

from pymicroglia.measure.modules.provenance import measure
