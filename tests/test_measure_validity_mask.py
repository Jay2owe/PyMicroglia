...
Ported from Motion's ``analysis/test_validity_mask.py`` on 2026-09-21 (stage 04 of the Motion port).
"""
...
from pymicroglia.measure.inputs import load_valid_mask
from pymicroglia.measure.modules import neighbours, object_geometry, objects
from pymicroglia.measure import MeasurementContext, ObjectStack, Scale
from pymicroglia.measure.summarise import build_frame_summary
