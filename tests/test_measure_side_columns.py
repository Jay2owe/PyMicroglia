...
Ported from Motion's ``analysis/test_side_columns_as_inputs.py`` on 2026-09-21 (stage 04 of the Motion port).
"""
...
from pymicroglia.measure.run import _granted_side_columns, _side_columns_used
...
def test_coupling_computes_a_lag_profile_against_a_granted_side_column() -> None:
    ...
    from pymicroglia.measure.modules.coupling import derive
