...
Ported from Motion's ``analysis/test_object_geometry.py`` on 2026-09-21 (stage 04 of the Motion port).
"""
...
from pymicroglia.measure.modules.object_geometry import measure
from pymicroglia.measure import MeasurementContext, ObjectStack, Scale
...
def test_neither_table_folds_into_a_rollup():
    ...
    _load_modules()
    from pymicroglia.measure.declare import declared_tables
    from pymicroglia.measure.run import _fold_target
...
def test_the_column_names_do_not_collide_with_the_cell_to_cell_ones():
    ...
    """
    from pymicroglia.measure.modules import neighbours, object_geometry
