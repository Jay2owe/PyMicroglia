...
## What went wrong
PyMicroglia's video implementation moved to PySCNSlice and four legacy export
...
public generic renderer is the installed PySCNSlice function, and established
...
to its owning package. Deep renderer parity belongs to the PySCNSlice suite;
